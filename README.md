...
Yêu cầu môi trường: **Node.js >= 20** và **pnpm**.
...
Dự án đã có sẵn cấu hình chuẩn [`vercel.json`](./vercel.json). Để triển khai lên tài khoản Vercel của bạn với tên miền riêng:

1. Truy cập [vercel.com/new](https://vercel.com/new) và đăng nhập bằng GitHub.
2. Tìm kiếm repository **`LongLeo287/HNAG`** và bấm **Import**.
3. Tại ô **Project Name**: Đặt tên miền mong muốn (ví dụ: `hnag`).
4. Bấm **Deploy**.
5. Vercel sẽ tự động build và cung cấp đường dẫn chính thức `https://<ten-project>.vercel.app` với cơ chế CI/CD tự động cập nhật mỗi lần push code!

---

## 📜 Giấy phép

Phát triển bởi [LongLeo287](https://github.com/LongLeo287). Hoàn toàn miễn phí và phi thương mại.
